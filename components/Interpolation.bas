...
Sub test_interp()
Dim x_rng As Range, y_rng As Range, z_rng As Range
Dim x As Double, y As Double, v As Double

Set x_rng = Range("$Q$18:$Q$53")
Set y_rng = Range("$R$17:$X$17")
Set z_rng = Range("$R$18:$X$53")

x = 1000#
y = 44347#

v = Interp2(x_rng, y_rng, z_rng, x, y)
